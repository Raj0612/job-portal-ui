        ...
        <div className="relative border-t border-gray-700/50 mt-16 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <Tooltip text="We respect your privacy. Learn how we collect, use, and protect your personal information across JobPortal.">
                <a className="group relative hover:text-white transition-colors duration-300">
                  <span className="relative z-10">Privacy Policy</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-primary-600/20 to-purple-600/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -inset-2"></div>
                </a>
              </Tooltip>
              <Tooltip text="By using JobPortal, you agree to our terms governing acceptable use, account responsibilities, and service availability.">
                <a className="group relative hover:text-white transition-colors duration-300">
                  <span className="relative z-10">Terms of Service</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-primary-600/20 to-purple-600/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -inset-2"></div>
                </a>
              </Tooltip>
              <Tooltip text="We use cookies to enhance your experience and analyze site traffic. See how we use cookies across JobPortal.">
                <a className="group relative hover:text-white transition-colors duration-300">
